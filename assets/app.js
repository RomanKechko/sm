...
$(document).ready(function () {
  ...
  $(".nav").css({
    backgroundSize:
      Math.floor((blockWidth - buttonWidth) / 2) -
      1 +
      "px 1px, " +
      (Math.round((blockWidth - buttonWidth) / 2) - 1) +
      "px 1px",
  });
...
$('[data-fancybox="photo-slider1"]').fancybox(param);

$('[data-fancybox="photo-slider2"]').fancybox(param);

$('[data-fancybox="photo-slider3"]').fancybox(param);

$('[data-fancybox="photo-slider4"]').fancybox(param);

$('[data-fancybox="photo-slider5"]').fancybox(param);

$('[data-fancybox="photo-slider6"]').fancybox(param);

$('[data-fancybox="photo-slider7"]').fancybox(param);

$('[data-fancybox="photo-slider8"]').fancybox(param);

$('[data-fancybox="photo-slider9"]').fancybox(param);
...
$(".swiper-slide-duplicate").on("click", function (event) {
  ...
  $(
    '[data-swiper-slide-index="' +
      this.getAttribute("data-swiper-slide-index") +
      '"][data-slider="' +
      this.getAttribute("data-slider") +
