...
async function formSubmit(e) {
  ...
  alertTitle.className = response.ok ? 'alert__title alert__title_ok':'alert__title alert__title_error';
  alertTitle.textContent = response.ok ? 'Ваше сообщение успешно отправленно!':'Ошибка на сервере.';
  alertText.textContent = response.ok ? 'Мы ответим Вам в ближайшее время.':'Письмо не может быть доставленно, пожалуйста свяжитесь с нами - +74952221942';
